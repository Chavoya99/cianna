<div class="py-3">
    ...
    <div class="flex flex-wrap">
        <div class="w-4/6 px-2">
            ...
            <x-custom-input id="calle" name="calle" class="w-full" required></x-custom-input>
        </div>
        <div class="w-1/6 px-2">
            <x-custom-label for="num_ext">N° ext.</x-custom-label>
            <x-custom-input id="num_ext" name="num_ext" class="w-full" type="number" required></x-custom-input>
        </div>
        <div class="w-1/6 px-2">
            <x-custom-label for="num_int">N° int.</x-custom-label>
            <x-custom-input id="num_int" name="num_int" class="w-full" type="number"></x-custom-input>
        </div>
    </div>
    <div class="flex flex-wrap mt-12">
        <div class="w-1/5 px-2">
            <x-custom-label for="cod_post">C.P.</x-custom-label>
            <x-custom-input id="cod_post" name="cod_post" class="w-full" type="number" required></x-custom-input>
        </div>
