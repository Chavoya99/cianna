...
<div class="flex flex-wrap">
    <div>
        ...
        <div class="flex items-center">
            <label class="mr-8">
                <input type="radio" name="mascota" value="si" id="mascota-si" class="w-4 h-4 text-cianna-orange focus:ring-cianna-orange focus:ring-2 hover:cursor-pointer">
                Sí
            </label>
            <label>
                <input type="radio" name="mascota" value="no" id="mascota-no" class="w-4 h-4 text-cianna-orange focus:ring-cianna-orange focus:ring-2 hover:cursor-pointer">
                No
            </label>
        </div>
    </div>
